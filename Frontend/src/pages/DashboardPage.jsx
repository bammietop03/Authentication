...
const DashboardPage = () => {
  ...
  return (
    <motion.div
      ...
      className="max-w-md w-full mt-10 p-8 bg-gray-900 bg-opacity-60 backdrop-filter backdrop-blur-lg rounded-xl shadow-2xl border border-gray-800 mx-5 md:mx-0"
    >
